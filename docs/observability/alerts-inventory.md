...
| `rf-doc-size-alarm` | PostHog log alert | [`ops/posthog-alerts/`](../../ops/posthog-alerts/) | ≥1 WARN log from control-panel containing `DOC_SIZE_ALARM` in 60min (nightly sweep flagged a Show doc >12MB est or >1,000 votes entries) | P2 | [`doc-size-alarm.md`](../runbooks/doc-size-alarm.md) |
