...
|---|---|---:|---|:---:|
| [`apps/viewer`](../apps/viewer) | Quarkus 21 native | 96 `@Test` | 60% line / 60% branch (JaCoCo) | ✓ |
...
| [`apps/ui`](../apps/ui) | Vite + React + Vitest | 728 tests across 90 files | 22% line (Vitest v8) | ✓ |
