...
| [`apps/control-panel`](../apps/control-panel) | Spring Boot 3 native | 348 `@Test` | 76% line / 68% branch (JaCoCo, BUNDLE) | ✓ |
...
| [`apps/ui`](../apps/ui) | Vite + React + Vitest | 462 tests across 65 files | 30% line (Vitest v8) | ✓ |
